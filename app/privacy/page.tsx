  ...
  return (
    <div className="text-text-secondary w-full px-4 py-14 sm:px-6 sm:py-20">
      <article className="panel mx-auto max-w-4xl p-6 md:p-10">
        <h1 className="font-700 text-text-primary mb-8 text-3xl sm:text-4xl">개인정보처리방침</h1>

        <div className="flex flex-col gap-8 text-sm leading-relaxed">
          <section>
            <h2 className="font-display font-700 text-text-primary mb-3 text-lg">1. 총칙</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-700 text-text-primary mb-3 text-lg">2. 수집하는 개인정보의 항목</h2>
          ...
          <section>
            <h2 className="font-display font-700 text-text-primary mb-3 text-lg">3. 개인정보의 수집 및 이용목적</h2>
          ...
          <section>
            <h2 className="font-display font-700 text-text-primary mb-3 text-lg">4. 개인정보의 보유 및 이용기간</h2>
            <p>
              ...
              규정에 의하여 보존할 필요가 있는 경우 회사는 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
            </p>
          </section>

          <section>
            <h2 className="font-display font-700 text-text-primary mb-3 text-lg">
              5. 이용자 및 법정대리인의 권리와 그 행사방법
            </h2>
            <p>
              이용자 및 법정대리인은 언제든지 등록되어 있는 자신 혹은 당해 만 14세 미만 아동의 개인정보를 조회하거나
              수정할 수 있으며 가입해지를 요청할 수도 있습니다. 개인정보의 조회/수정을 위해서는
          ...
          <section>
            <h2 className="font-display font-700 text-text-primary mb-3 text-lg">6. 개인정보 보호책임자</h2>
            <p className="mb-2">

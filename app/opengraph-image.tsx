    ...
    >
      <div
        style={{
          ...
          borderRadius: 999,
          background:
            'radial-gradient(circle, rgba(168,200,232,0.72) 0%, rgba(207,231,255,0.32) 46%, rgba(255,255,255,0) 74%)',
        }}
      />
      <div
        style={{ display: 'flex', width: '100%', flexDirection: 'column', justifyContent: 'space-between', zIndex: 1 }}
      >
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 50 }}>
          <div style={{ display: 'flex', flexDirection: 'column', maxWidth: 650 }}>
            ...
            <div style={{ marginTop: 22, fontSize: 26, lineHeight: 1.5, color: '#60646c' }}>
              로그인 없이 올리고, 기억하기 쉬운 한글 코드로 바로 공유하세요.
            </div>
          </div>
          <div
            style={{
              ...
              boxShadow: '0 18px 50px rgba(20,55,82,0.12)',
            }}
          >
            ...
            >
              <div
                style={{ display: 'flex', width: '72%', height: '100%', borderRadius: 999, background: '#0d74ce' }}
              />
            </div>
          </div>
        </div>
...
function BrandMark({ size: markSize }: { size: number }) {
  return (
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" width={markSize} height={markSize}>
      <path
        d="M8 50V14c0-3.4 4-5.2 6.6-2.9L32 26.6l17.4-15.5C52 8.8 56 10.6 56 14v36h-9V25.1L35.2 35.7a4.8 4.8 0 0 1-6.4 0L17 25.1V50H8Z"
        fill="#171717"
      />
